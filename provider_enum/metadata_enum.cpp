...
void get_metadata(LPWSTR pwszPublisherName)
{

    g_hMetadata = NULL;
    g_ChannelMessages = { 0, NULL };
    g_LevelMessages = { 0, NULL };
    g_TaskMessages = { 0, NULL };
    g_OpcodeMessages = { 0, NULL };
    g_KeywordMessages = { 0, NULL };

    //LPCWSTR pwszPublisherName = L"Microsoft-Windows-Security-Auditing";
    //const wchar_t* constPwszPublisherName = L"Microsoft-Windows-Security-Auditing";
    //size_t length = wcslen(constPwszPublisherName) + 1;
    //pwszPublisherName = new wchar_t[length];
    //wcsncpy_s(pwszPublisherName, length, constPwszPublisherName, length - 1);
